<?php
    ...
    if(isset($_POST["create"])){
        ...
        if(isset($_SESSION["adm"])){
            ...
            $sql = "INSERT INTO `animals`(`name`, `address`, `description`, `age`, `vaccinated`, `breed`, `status`, `picture`,`agency_id_fk`) VALUES ('$name','$address', '$description','$age','$vaccinated','$breed','$status','{$picture[0]}','$agencyID')";
        }
        else{
            $agencyID = $rowUser["id"];
            $sql = "INSERT INTO `animals`(`name`, `address`, `description`, `age`, `vaccinated`, `breed`, `status`, `picture`,`agency_id_fk`) VALUES ('$name','$address', '$description','$age','$vaccinated','$breed','$status','{$picture[0]}','$agencyID')";
        ...
        <form method="POST" enctype="multipart/form-data"> 
           <div class="mb-4 mt-5">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control"  id="age"  aria-describedby="age"  placeholder="5 Months / 2 Years" name="age">
            </div>
            <div class="mb-4">
