    ...
    <div class="container d-flex flex-row justify-content-evenly flex-wrap flex-sm-wrap flex-md-wrap flex-lg-nowrap flex-xl-nowrap flex-xxl-nowrap gap-5">
        ...
        <div class="mt-5">
            <div class="card card-body mt-5 rounded-4 faqCard shadow" style="width: 25vw;">
                ...
                <div class="card-body">
                    <p>The system caters to three distinct user categories, each playing a crucial role in the pet adoption process: the Customer/User and the Shelter. In addition, an Admin oversees user coordination and manages user roles within the platform.</p>
