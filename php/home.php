<?php
    ...
    <div class='row row-cols-xl-4 row-cols-md-2 row-cols-s-1 gap-3'>
        ...
        <button name='allAnimals' class='btn btn-dark mybtn' type='submit'>All Dogs</button>
        </form>
        <form method='post' enctype='multipart/form-data' class='myForm'>
        <button name='availableAnimals' class='btn btn-dark mybtn' type='submit'>Available Dogs</button>
        </form>
        <form method='post' enctype='multipart/form-data' class='myForm'>
        <button name='adoptedAnimals' class='btn btn-dark mybtn' type='submit'>Adopted Dogs</button>
        </form>
    </div>
    ";
    if(!isset($_SESSION["user"]) && !isset($_SESSION["adm"]) && !isset($_SESSION["shelter"])){
        ...
        if(isset($_SESSION["shelter"])){
            ...
            <div class='row row-cols-xl-4 row-cols-md-2 row-cols-s-1 gap-3'>
            <form method='post' enctype='multipart/form-data' class='myForm'>
            <button name='findShelterAnimals' class='btn btn-dark mybtn' type='submit'>Own Dogs</button>
            </form>
                <form method='post' enctype='multipart/form-data' class='myForm'>
                <button name='availableAnimals' class='btn btn-dark mybtn' type='submit'>Available Dogs</button>
                </form>
        ...
        if(isset($_SESSION["adm"])){
            ...
            <div class='row row-cols-xl-4 row-cols-md-2 row-cols-s-1 gap-3 mt-5'>
                <form method='post' enctype='multipart/form-data' class='myForm'>
                    <button name='availableAnimals' class='btn btn-dark mybtn text-nowrap' type='submit'>Available Dogs</button>
                </form>
                <form method='post' enctype='multipart/form-data' class='myForm'>
                    <button name='adoptedAnimals' class='btn btn-dark mybtn text-nowrap ms-3' type='submit'>Adopted Dogs</button>
                </form>
            </div>
            ";
        }
        ...
        while($rowAnimal = mysqli_fetch_assoc($resultAnimals)){
            ...
            <div class='card gap-2 mt-5 mb-5 shadow align-items-center' style='width: 17rem;'>
                ...
                <div class='card-body '>
                    ...
                    <hr class='TitleHR'>
                    <p class='card-text ps-3 mt-4'><b>Age:</b> <br> {$rowAnimal["age"]}</p>
                    {$bttn}
                    </div>
                </div>
          </div>";
...
<body>
    ...
    <div class="headerImage mb-5">
        <p id="hero">I am Waiting <br>For You!</p>
    </div>

    <div class="text-center">
        <h2 class="text-center mt-5" id="welcome">Welcome to Pawfect!</h2>
